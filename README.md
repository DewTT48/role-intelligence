...
ลิงก์เข้าสู่ระบบชี้ไปยัง Role Intelligence Production V3.4.2 ส่วน Lead API ยังคงใช้บริการรับคำขอเดโมเดิม

ใน V3.4.2 ระบบจะบันทึกและตรวจสอบ Version 1 โดยอัตโนมัติหลังสร้าง JD สำเร็จ การแก้ไขด้วยผู้ใช้หรือ AI จะอยู่ในสถานะร่าง และสร้าง Version ถัดไปเมื่อผู้ใช้กดบันทึกเท่านั้น
